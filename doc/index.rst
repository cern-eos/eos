...
.. epigraph::
   ...
   *EOS BERYLL* supports also flexible eraseure encoding of files with two or three redundancy stripes optimizing disk space usage. Files can be accessed via native XRootD protocol, a POSIX-like *FUSE* client or *HTTP(S) & WebDav* protocol. 

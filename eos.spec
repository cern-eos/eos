...
BuildRequires: xrootd-server = 3.3.1
BuildRequires: xrootd-server-devel = 3.3.1
BuildRequires: xrootd-private-devel  = 3.3.1
...
/usr/lib64/libXrdEosMgm.so.0.3.0

...
%files -n eos-server
%defattr(-,root,root)
/usr/lib64/libXrdMqOfs.so.0.3.17
...
/usr/lib64/libXrdEosMgm.so.0.3.17
...
/usr/bin/eosdropboxd
/usr/bin/eoscp
/usr/lib64/libXrdMqClient.so.0.3.17
/usr/lib64/libXrdMqClient.so.0
/usr/lib64/libXrdMqClient.so
/usr/lib64/libeosCommon.so.0.3.17

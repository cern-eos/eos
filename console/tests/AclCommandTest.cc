...
void AclCommandTest::setUp(void)
{

}

void AclCommandTest::tearDown(void)
{
...
void AclCommandTest::TestFunctionality()
{
  ...
  // Single add
  {
    ...
    temp.second = "Virtual Identity: uid=0 (2,99,3,0) gid=0 (99,4,0) [authz:sss] sudo* host=localhost";
    test.m_mgm_execute.m_queue.push(temp);
    ...
    temp.first = std::string("mgm.cmd=attr&mgm.subcmd=set&mgm.attr.key=sys.acl&mgm.attr.value=u:user1:w!d+d!u&mgm.path=/test");
    temp.second = "success: set attribute sys.acl=\"u:user1:w!d+d!u\" in file/directory /test";
    test.m_mgm_execute.m_queue.push(temp);
  ...
  // Recursive set
  {
    ...
    temp.first = std::string("mgm.cmd=attr&mgm.subcmd=set&mgm.attr.key=sys.acl&mgm.attr.value=g:group1:w+d!uc,u:user1:w!d+d!u&mgm.path=/test/");
    temp.second = "success: set attribute sys.acl=\"g:group1:w+d!uc,u:user1:w!d+d!u\" in file/directory /test";
    test.m_mgm_execute.m_queue.push(temp);
    ...
    temp.first = std::string("mgm.cmd=attr&mgm.subcmd=set&mgm.attr.key=sys.acl&mgm.attr.value=g:group1:w+d!uc&mgm.path=/test/abc/");
    temp.second = "success: set attribute sys.acl=\"g:group1:w+d!uc\" in file/directory /test/abc";
    test.m_mgm_execute.m_queue.push(temp);
    ...
    temp.first = std::string("mgm.cmd=attr&mgm.subcmd=set&mgm.attr.key=sys.acl&mgm.attr.value=g:group1:w+d!uc&mgm.path=/test/abc/a/");
    temp.second = "success: set attribute sys.acl=\"g:group1:w+d!uc\" in file/directory /test/abc/a";
    test.m_mgm_execute.m_queue.push(temp);
    ...
    temp.first = std::string("mgm.cmd=attr&mgm.subcmd=set&mgm.attr.key=sys.acl&mgm.attr.value=g:group1:w+d!uc&mgm.path=/test/abc/b/");
    temp.second = "success: set attribute sys.acl=\"g:group1:w+d!uc\" in file/directory /test/abc/b";
    test.m_mgm_execute.m_queue.push(temp);
    ...
    temp.first = std::string("mgm.cmd=attr&mgm.subcmd=set&mgm.attr.key=sys.acl&mgm.attr.value=g:group1:w+d!uc&mgm.path=/test/abc/c/");
    temp.second = "success: set attribute sys.acl=\"g:group1:w+d!uc\" in file/directory /test/abc/c";
    test.m_mgm_execute.m_queue.push(temp);
    ...
    temp.first = std::string("mgm.cmd=attr&mgm.subcmd=set&mgm.attr.key=sys.acl&mgm.attr.value=g:group1:w+d!uc&mgm.path=/test/test1/");
    temp.second = "success: set attribute sys.acl=\"g:group1:w+d!uc\" in file/directory /test/test1";
    test.m_mgm_execute.m_queue.push(temp);
    ...
    temp.first = std::string("mgm.cmd=attr&mgm.subcmd=set&mgm.attr.key=sys.acl&mgm.attr.value=g:group1:w+d!uc&mgm.path=/test/test1/d/");
    temp.second = "success: set attribute sys.acl=\"g:group1:w+d!uc\" in file/directory /test/test1/d";
    test.m_mgm_execute.m_queue.push(temp);
    ...
    temp.first = std::string("mgm.cmd=attr&mgm.subcmd=set&mgm.attr.key=sys.acl&mgm.attr.value=g:group1:w+d!uc&mgm.path=/test/test1/e/");
    temp.second = "success: set attribute sys.acl=\"g:group1:w+d!uc\" in file/directory /test/test1/e";
    test.m_mgm_execute.m_queue.push(temp);
    ...
    temp.first = std::string("mgm.cmd=attr&mgm.subcmd=set&mgm.attr.key=sys.acl&mgm.attr.value=g:group1:w+d!uc&mgm.path=/test/test1/f/");
    temp.second = "success: set attribute sys.acl=\"g:group1:w+d!uc\" in file/directory /test/test1/f";
    test.m_mgm_execute.m_queue.push(temp);
    ...
    temp.first = std::string("mgm.cmd=attr&mgm.subcmd=set&mgm.attr.key=sys.acl&mgm.attr.value=g:group1:w+d!uc&mgm.path=/test/test2/");
    temp.second = "success: set attribute sys.acl=\"g:group1:w+d!uc\" in file/directory /test/test2";
    test.m_mgm_execute.m_queue.push(temp);

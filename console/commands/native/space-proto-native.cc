...
std::string MakeSpaceHelp()
{
  ...
  oss << " usage:\n"
      ...
      << "space config <space-name> space.scheduler.type=<type>                 : "
         "which placement engine the space uses. The value names the engine "
         "first: 'geotree' is the legacy engine and the default for a space "
         "that never set this key; every flat scheduler strategy carries a "
         "'flat:' prefix - flat:geo, flat:roundrobin, "
         "flat:threadlocalroundrobin, flat:random, flat:fidrandom, "
         "flat:weightedrandom, flat:weightedroundrobin. The spellings that "
         "predate the prefix still work but are deprecated. An unknown value "
         "is refused\n"

...
std::string MakeSpaceHelp()
{
  ...
  oss << " usage:\n"
      ...
      << "space config <space-name> space.scheduler.type=<type>                 : "
         "configure the default scheduler for space, eg. geotree (default, legacy "
         "engine), geo, roundrobin, weightedrandom etc\n"
      ...
      << "  (directory override: sys.forced.cachespace=<cache-space>|none on the parent dir)\n"

...
com_attr_usage:
  ...
  fprintf(stdout, "         sys.forced.placementpolicy=<policy>[:geotag] : enforces to use replica/stripe placement policy <policy> [<policy>={scattered|hybrid:<geotag>|gathered:<geotag>}]\n");
  fprintf(stdout, "         sys.forced.noplacementpolicy=1               : disables user defined replica/stripe placement policy\n");
  ...
  fprintf(stdout, "         sys.forced.minsize=<bytes>            : set's the minimum number of bytes a file to be stored must have\n");
  fprintf(stdout, "         sys.forced.maxsize=<bytes>            : set's the maximum number of bytes a file to be stored can have\n");
...
// ---------------------------------------------------------------------------
  ...
  fprintf(stdout, "         sys.mask                              : masks all chmod requests with the given mask for directories - if defined the ACL bit fobidding 'chmod' requests is deactivated and the mask applied\n");
  ...
  fprintf(stdout, "         user.forced.placementpolicy=<policy>[:geotag] : s.a.\n");
  fprintf(stdout, "         user.forced.noplacementpolicy=1               : s.a.\n");

...
com_attr (char* arg1) {
 ...
 com_attr_usage:
  ...
  printf("               => <rule> = u:<uid|username>>|g:<gid|groupname>|egroup:<name>:{rwom(!d)(+d)} \n\n");
  ...
  printf("              '+d' : this tag can be used to overwrite a group rule excluding deletion via '!d' for certain users\n");

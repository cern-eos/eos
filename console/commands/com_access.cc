...
com_access_usage:
  ...
  fprintf(stdout, "                                                : set find query limit to <nfiles> for user {name}\n");
  fprintf(stdout, "access set limit <ndirs> rate:user:{name}:FindDirs\n");
  fprintf(stdout, "                                                : set find query limit to <ndirs> for user {name}\n");
  fprintf(stdout, "access set limit <nfiles> rate:group:{name}:FindFiles\n");
  fprintf(stdout, "                                                : set find query limit to <nfiles> for group {name}\n");
  fprintf(stdout, "access set limit <ndirs> rate:group:{name}:FindDirs\n");
  fprintf(stdout, "                                                : set find query limit to <ndirss> for group {name}\n");
  fprintf(stdout, "access set limit <nfiles> rate:user:*:FindFiles\n");
  fprintf(stdout, "                                                : set default find query limit to <nfiles> for everybody\n");

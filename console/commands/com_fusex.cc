...
com_fusex_usage:
  ...
  fprintf(stdout, "                                                            <reason> -  optional text shown to the client why he has been evicted\n");
  fprintf(stdout, "\n");
  fprintf(stdout, "       fusex dropcaps <uuid>                                         :  advice a client to drop all caps\n");
  fprintf(stdout, "\n");
  fprintf(stdout, "       fusex droplocks <inode> <pid>                                 :  advice a client to drop for a given (hexadecimal) inode and process id\n");
  fprintf(stdout, "\n");
  fprintf(stdout, "       fusex caps [-t | -i | -p [<regexp>] ]                         :  print caps\n");
  fprintf(stdout, "                -t                                                   -  sort by expiration time\n");
  fprintf(stdout, "                -i                                                   -  sort by inode\n");
  fprintf(stdout, "                -p                                                   -  display by path\n");

...
//------------------------------------------------------------------------------
//! Class PthreadRWMutex implementing fair rw mutex prefering writers
//------------------------------------------------------------------------------
...
public:
  ...
  //! Constructor
  // ---------------------------------------------------------------------------
  PthreadRWMutex(bool preferreader = false);
  ...
  //----------------------------------------------------------------------------
  inline void SetBlocking(bool block) override
  {
    mBlocking = block;
  }
...
private:
  ...
  // rulename -> order
  typedef std::map< std::string , std::vector<IRWMutex*> > rules_t;

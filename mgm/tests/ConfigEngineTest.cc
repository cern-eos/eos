...
{
  engine = new RedisConfigEngine("/var/eos/config/eos-dev01.cern.ch/","localhost",6379);
}
...
void ConfigEngineTest::LoadConfigTest()
{
  ...
  XrdOucEnv env = XrdOucEnv("mgm.cmd=config&mgm.subcmd=load&mgm.config.file=default");

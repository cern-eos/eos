...
class GetTapeWellKnownModelJsonifier : public
  common::JsonCppJsonifier<GetTapeWellKnownModel>
{
  void jsonify(const GetTapeWellKnownModel* model,
               std::stringstream& oss) override;
};

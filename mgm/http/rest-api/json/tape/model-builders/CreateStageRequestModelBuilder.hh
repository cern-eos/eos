 ...
 */
class CreateStageRequestModelBuilder : public
  JsonCppModelBuilder<CreateStageBulkRequestModel>
{
public:
  CreateStageRequestModelBuilder(const std::string& restApiEndpointId);
  virtual std::unique_ptr<CreateStageBulkRequestModel> buildFromJson(

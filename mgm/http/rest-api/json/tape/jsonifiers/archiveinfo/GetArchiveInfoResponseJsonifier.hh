...
class GetArchiveInfoResponseJsonifier
  : public TapeRestApiJsonifier<GetArchiveInfoResponseModel>,
    public common::JsonCppJsonifier<GetArchiveInfoResponseModel>
{
public:
  void jsonify(const GetArchiveInfoResponseModel* obj,

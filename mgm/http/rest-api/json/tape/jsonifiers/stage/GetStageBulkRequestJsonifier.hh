...
/**
 * Transforms a GetStageBulkRequestResponseModel into JSON
 */
class GetStageBulkRequestJsonifier
  : public TapeRestApiJsonifier<GetStageBulkRequestResponseModel>,
    public common::JsonCppJsonifier<GetStageBulkRequestResponseModel>
{
public:
  void jsonify(const GetStageBulkRequestResponseModel* model,

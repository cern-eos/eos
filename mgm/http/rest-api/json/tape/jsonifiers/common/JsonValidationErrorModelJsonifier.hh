 ...
 */
class JsonValidationErrorModelJsonifier : public ErrorModelJsonifier,
  public TapeRestApiJsonifier<JsonValidationErrorModel>,
  public common::JsonCppJsonifier<JsonValidationErrorModel>
{
public:
  void jsonify(const JsonValidationErrorModel* model,

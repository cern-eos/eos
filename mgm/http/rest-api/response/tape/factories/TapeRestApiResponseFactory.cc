...
RestApiResponse<ErrorModel> TapeRestApiResponseFactory::createBadRequestError(const JsonValidationException& ex) const {
  ...
  return createError(common::HttpResponse::BAD_REQUEST,"JSON Validation error",detail);
}

...
/*----------------------------------------------------------------------------*/
{
  ...
  if (isCreation || ((open_mode == SFS_O_TRUNC) && (!fmd->getNumLocation())) ||
    ...
    plctargs.firewallentpts = (vid.geolocation ==
                               eos::common::Mapping::PROXY_GEOTAG) ? &firewalleps : NULL;
    ...
    acsargs.firewallentpts = (vid.geolocation == eos::common::Mapping::PROXY_GEOTAG)
                             ? &firewalleps : NULL;

...
Iostat::UdpBroadCast (eos::common::Report* report)
{
  ...
  for (it = mUdpPopularityTarget.begin(); it != mUdpPopularityTarget.end(); it++)
  {
    ...
    if (tg.endswith("/json"))
    {
      ...
      u += ",\n";
      u += " \"read_average\": ";
      u += eos::common::StringConversion::GetSizeString(sizestring, report->rb / ((report->nrc) ? report->nrc : 999999999));
      u += ",\n";
      ...
      u += "\",\n";
      u += " \"write_average\": ";
      u += eos::common::StringConversion::GetSizeString(sizestring, report->wb / ((report->nwc) ? report->nwc : 999999999));
      u += ",\n";

...
//    << "|pxyG:"<< (*pTreeInfo)[node].proxygroup
  ...
  bool
  findFreeSlotFirstHitBack(tFastTreeIdx& newReplica, tFastTreeIdx startFrom=0, bool decrFreeSlot = true)
  {
    ...
    else
    {
      if (startFrom)
      {
        return findFreeSlotFirstHitBack(newReplica, pNodes[startFrom].treeData.fatherIdx, decrFreeSlot);
      }
      else
      return false;
    }

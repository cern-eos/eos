...
XrdMgmOfs::Configure (XrdSysError &Eroute)
{
  ...
  gOFS->MgmStats.Add("FUSEx-0-HANDLE", 0, 0, 0);
  gOFS->MgmStats.Add("FUSEx-0-STREAM", 0, 0, 0);
  gOFS->MgmStats.Add("FUSEx-GET", 0, 0, 0);
  gOFS->MgmStats.Add("FUSEx-SET", 0, 0, 0);
  gOFS->MgmStats.Add("FUSEx-LS", 0, 0, 0);
  gOFS->MgmStats.Add("FUSEx-CREATE", 0, 0, 0);
  gOFS->MgmStats.Add("FUSEx-UPDATE", 0, 0, 0);
  gOFS->MgmStats.Add("FUSEx-MKDIR", 0, 0, 0);
  gOFS->MgmStats.Add("FUSEx-RMDIR", 0, 0, 0);
  gOFS->MgmStats.Add("FUSEx-RENAME", 0, 0, 0);
  gOFS->MgmStats.Add("FUSEx-MV", 0, 0, 0);
  gOFS->MgmStats.Add("FUSEx-DELETE", 0, 0, 0);
  gOFS->MgmStats.Add("FUSEx-GETCAP", 0, 0, 0);
  gOFS->MgmStats.Add("FUSEx-SETLK", 0, 0, 0);
  gOFS->MgmStats.Add("FUSEx-GETLK", 0, 0, 0);
  gOFS->MgmStats.Add("FUSEx-SETLKW", 0, 0, 0);
  gOFS->MgmStats.Add("FUSEx-BEGINFLUSH", 0, 0, 0);
  gOFS->MgmStats.Add("FUSEx-ENDFLUSH", 0, 0, 0);
  gOFS->MgmStats.Add("FUSEx-CREATELNK", 0, 0, 0);
  gOFS->MgmStats.Add("FUSEx-DELETELNK", 0, 0, 0);

...
private:
  ...
  //!
  //! @param cksumType, output parameter containing the checksum type (can be empty if no
  //! such information)
  //! @param cksumValue, output parameter containg the checksum value (can be empty if no
  //! such information)
  //----------------------------------------------------------------------------

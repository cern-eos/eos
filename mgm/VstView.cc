                ...
                const char* selection)
{
  ...
  const char* format = "%s %-16s %-4s %-24s %-16s %-6s %-10s %-8s %12s %8s %5s %5s %5s %12s %12s %8s\n";
  const char* ioformat = "%s %-16s %-4s %12s %8s %12s %12s %8s %5s %5s %10s %10s %10s %10s %5s %5s\n";
  char line[4096];
  if (!monitoring)
  {
    if (ioformating)
    ...
    out += "# _______________________________________________________________________________________________________________________________________________________________________\n";
    out += line;
    out += "# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------\n";
  }
  if (!monitoring)

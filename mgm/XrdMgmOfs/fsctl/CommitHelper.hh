...
public:
  ...
  static int check_filesystem(eos::common::Mapping::VirtualIdentity_t& vid,
  ...
  static void log_info(eos::common::Mapping::VirtualIdentity_t& vid,
                       eos::common::LogId& ThreadLogId,
                       CommitHelper::cgi_t& cgi,
                       CommitHelper::option_t& option,
                       CommitHelper::param_t& params);
  ...
  static bool validate_size(eos::common::Mapping::VirtualIdentity_t& vid,
                            eos::common::LogId& ThreadLogId,
                            std::shared_ptr<eos::IFileMD> fmd,
                            unsigned long fsid,
                            unsigned long long size);

  static bool validate_checksum(eos::common::Mapping::VirtualIdentity_t& vid,
                                eos::common::LogId& ThreadLogId,
                                std::shared_ptr<eos::IFileMD> fmd,
                                eos::Buffer& checksumbuffer,
                                unsigned long long fsid);

  static void log_verifychecksum(eos::common::Mapping::VirtualIdentity_t& vid,
                                 eos::common::LogId& ThreadLogId,
                                 std::shared_ptr<eos::IFileMD>fmd,
                                 eos::Buffer& checksumbuffer,
                                 unsigned long fsid,
  ...
  static bool handle_location(eos::common::Mapping::VirtualIdentity_t& vid,
                              eos::common::LogId& ThreadLogId,
                              unsigned long cid,
                              std::shared_ptr<eos::IFileMD> fmd,
                              unsigned long fsid,
  ...
  static void handle_occhunk(eos::common::Mapping::VirtualIdentity_t& vid,
                             eos::common::LogId& ThreadLogId,
                             std::shared_ptr<eos::IFileMD>& fmd,
                             CommitHelper::option_t& option,
  ...
  static void handle_checksum(eos::common::Mapping::VirtualIdentity_t& vid,
                              eos::common::LogId& ThreadLogId,
                              std::shared_ptr<eos::IFileMD>fmd,
                              CommitHelper::option_t& option,
                              eos::Buffer& checksumbuffer);

  static bool commit_fmd(eos::common::Mapping::VirtualIdentity_t& vid,
                         eos::common::LogId& ThreadLogId,
                         unsigned long cid,
                         std::shared_ptr<eos::IFileMD>fmd,
                         CommitHelper::option_t& option,
  ...
  static void handle_versioning(eos::common::Mapping::VirtualIdentity_t& vid,
                                eos::common::LogId& ThreadLogId,
                                unsigned long fid,
                                CommitHelper::path_t& paths,
                                CommitHelper::option_t& option,

...
public:
  ...
  virtual bool UpdateFromMgm(eos::common::FileSystem::fsid_t fsid,
                             ...
                             unsigned long long mtime_ns, int layouterror, std::string locations) = 0;

  // ---------------------------------------------------------------------------
  //! Resync File meta data found under path
  // ---------------------------------------------------------------------------
  virtual bool ResyncAllDisk(const char* path,
                             eos::common::FileSystem::fsid_t fsid, bool flaglayouterror) = 0;
  ...
  virtual bool ResyncMgm(eos::common::FileSystem::fsid_t fsid,
                         eos::common::FileId::fileid_t fid, const char* manager) = 0;
...
//  virtual size_t Query (eos::common::FileSystem::fsid_t fsid, std::string query, std::vector<eos::common::FileId::fileid_t> &fidvector)=0;
  ...
  virtual bool GetInconsistencyStatistics(eos::common::FileSystem::fsid_t fsid,
                                          ...
                                          std::map<std::string, std::set < eos::common::FileId::fileid_t> >& fidset) = 0;

...
public:
  ...
  //! Mark if we should forbid synchronization of files opened in RW mode -
  //! this applies for HTTP (CernBox) traffic. By default disabled.
  std::atomic<bool> mCboxForbidRwSync{false};

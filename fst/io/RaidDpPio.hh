...
//! @brief Implementation of the RAID-double parity layout using parallel IO
//------------------------------------------------------------------------------
...
#ifndef __EOSFST_RAIDDPPIO_HH__
#define __EOSFST_RAIDDPPIO_HH__
...
//------------------------------------------------------------------------------
//! Implementation of the RAID-double parity layout using parallel IO
//------------------------------------------------------------------------------
class RaidDpPio : public RaidMetaPio, public RaidDpLayout
{
  public:
    ...
    //!
    //--------------------------------------------------------------------------
    RaidDpPio( std::vector<std::string> stripeUrl,
               int                      numParity,
               bool                     storeRecovery,
               bool                     isStreaming,
               off_t                    stripeWidth, 

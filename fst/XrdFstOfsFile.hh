...
public:
  ...
  bool
  HasChecksumValidationError() const
  {
    return mChecksumErr.has_value();
  }

  const std::string&
  GetChecksumErrText() const
  {
...
public:
  ...
  std::optional<std::string> mChecksumErr; ///< Checksum error string object, to be used
                                           ///< by other layers (HTTP for example)

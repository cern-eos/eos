...
func newGateway(ctx context.Context, conn *grpc.ClientConn, opts []gwruntime.ServeMuxOption) (http.Handler, error) {
	...
	for _, f := range []func(context.Context, *gwruntime.ServeMux, *grpc.ClientConn) error{
		eos_echo_service.RegisterEchoServiceHandler,
//		standalone.RegisterUnannotatedEchoServiceHandler,
//		eos_echo_service.RegisterStreamServiceHandler,
//		eos_echo_service.RegisterABitOfEverythingServiceHandler,
//		eos_echo_service.RegisterFlowCombinationHandler,
//		eos_echo_service.RegisterNonStandardServiceHandler,
//		eos_echo_service.RegisterResponseBodyServiceHandler,
	} {

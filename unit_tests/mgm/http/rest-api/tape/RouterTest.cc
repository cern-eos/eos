...
eos::common::HttpResponse* makePlainResponse(int code)
{
  auto* response = new eos::common::PlainHttpResponse();
...
TEST(RouterTest, throwsActionNotFoundWhenNoRouteMatches)
{
  ...
  -> eos::common::HttpResponse* {
    return makePlainResponse(eos::common::HttpResponse::OK);
  });
...
TEST(RouterTest, dispatchesWhenPatternAndMethodMatch)
{
  ...
  router.add("/api/v1/stage/", eos::common::HttpHandler::Methods::POST,
             [](eos::common::HttpRequest*, const eos::common::VirtualIdentity*)
  -> eos::common::HttpResponse* {
    return makePlainResponse(eos::common::HttpResponse::CREATED);
  });

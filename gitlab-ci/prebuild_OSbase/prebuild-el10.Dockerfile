...
RUN dnf install -y dnf-plugins-core epel-release \
    ...
    && dnf install --nogpgcheck -y https://dl.fedoraproject.org/pub/epel/10/Everything/x86_64/Packages/j/jemalloc-5.3.0-10.el10_1.x86_64.rpm \
    && dnf install --nogpgcheck -y https://dl.fedoraproject.org/pub/epel/10/Everything/x86_64/Packages/j/jemalloc-devel-5.3.0-10.el10_1.x86_64.rpm

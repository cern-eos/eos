...
cp fcold_artifacts/RPMS/* $STORAGE_PATH_FC27
...
cp fcold_artifacts/SRPMS/* $STORAGE_PATH_FC27_SRPM
...
cp fcold_artifacts/RPMS/* $STORAGE_PATH_FC28
...
cp fcold_artifacts/SRPMS/* $STORAGE_PATH_FC28_SRPM

...
createrepo -q $STORAGE_PATH_CC7_SRPM
...
createrepo -q $STORAGE_PATH_SLC6_SRPM
...
createrepo -q $STORAGE_PATH_FCRH_SRPM
...
STORAGE_PATH_FCOLD_SRPM=${PATH_PREFIX}/${BRANCH}/${BUILD_TYPE}/fc-25/SRPMS
mkdir -p $STORAGE_PATH_FCOLD_SRPM
cp fcold_artifacts/SRPMS/* $STORAGE_PATH_FCOLD_SRPM
createrepo -q $STORAGE_PATH_FCOLD_SRPM

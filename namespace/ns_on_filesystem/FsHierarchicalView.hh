...
//! @brief File-system based hierarchical namespace implementation
//------------------------------------------------------------------------------

#ifndef __EOS_NS_FS_HIERARCHICAL_VIEW_HH__
#define __EOS_NS_FS_HIERARCHICAL_VIEW_HH__

#include "namespace/interface/IView.hh"
#include "namespace/interface/IContainerMDSvc.hh"
#include "namespace/interface/IFileMDSvc.hh"
#include "namespace/ns_on_filesystem/accounting/QuotaStats.hh"

EOSNSNAMESPACE_BEING

//------------------------------------------------------------------------------
//! File-system implementation of the hierarchical namespace
//------------------------------------------------------------------------------
...
#endif // __EOS_NS_FS_HIERARCHICAL_VIEW_HH__

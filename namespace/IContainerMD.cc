...
namespace eos
{
  ...
  // Constructor
  //----------------------------------------------------------------------------
  IContainerMD::IContainerMD(id_t id):
    pId(id),
    pParentId(0),
    pFlags(0),
    pName(""),
  ...
  // Copy constructor
  //----------------------------------------------------------------------------
  IContainerMD::IContainerMD(const IContainerMD &other)
  {
    *this = other;
  }
  ...
  // Asignment operator
  //----------------------------------------------------------------------------
  IContainerMD &IContainerMD::operator= ( const IContainerMD &other )
  {
    pId       = other.pId;
  ...
  //----------------------------------------------------------------------------
  void IContainerMD::serialize(Buffer &buffer) throw(MDException)
  {
  ...
  //----------------------------------------------------------------------------
  void IContainerMD::deserialize(Buffer &buffer) throw(MDException)
  {
    uint16_t offset = 0;
...
#define CANENTER 0x04
  ...
  //----------------------------------------------------------------------------
  bool IContainerMD::access(uid_t uid, gid_t gid, int flags)
  {

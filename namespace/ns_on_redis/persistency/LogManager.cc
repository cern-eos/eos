...
#include "namespace/ns_on_redis/persistency/LogManager.hh"
#include "namespace/ns_on_redis/persistency/ChangeLogFile.hh"
#include "namespace/ns_on_redis/persistency/ChangeLogConstants.hh"

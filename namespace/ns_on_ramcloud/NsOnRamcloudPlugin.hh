...
//! @brief  Namespace on Ramcloud plugin interface implementation
//------------------------------------------------------------------------------

#ifndef __EOS_NS_ON_RAMCLOUD_PLUGIN_HH__
#define __EOS_NS_ON_RAMCLOUD_PLUGIN_HH__
...
#endif // __EOS_NS_ON_RAMCLOUD_PLUGIN_HH__

...
/* -------------------------------------------------------------------------- */
{
  ...
  // These paths are concatenated into the opaque information of a proc command
  // verbatim, where a '&' reads as an argument separator. Seal them so the MGM
  // gets the name whole - it unseals every path operand of these commands.
...
/* -------------------------------------------------------------------------- */
{
  ...
  // See versionFile() - a '&' has to be sealed before it reaches the opaque
  // information of the proc command.

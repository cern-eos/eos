...
void usage() 
{
  ...
  fprintf(stderr," example: ioverify /var/tmp/ 2048 0    # creates 2048 1MB test pattern files under /var/tmp/\n");
  fprintf(stderr,"          ioverify /var/tmp/ 2048 1000 # runs 1000 random verifications on all 2048 files under /var/tmp/\n");
  exit(-1);
}

...
public:
  ...
  public:
    ...
    static std::mutex gExpiredChunksMutex; // protecting expired global expired chunks vector
    static std::vector<std::shared_ptr<ReadAsyncHandler>> gExpiredChunks;     // global expired chunks vector

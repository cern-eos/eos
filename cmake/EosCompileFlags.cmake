...
if (AARCH64)
#set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${EOS_CXX_DEFINE} ${CPP_VERSION} -march=armv8-a+crc+crypto+crc32 -Wall -Wno-error=parentheses")
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${EOS_CXX_DEFINE} ${CPP_VERSION} -march=armv8-a+crc+crypto -Wall -Wno-error=parentheses")
else()

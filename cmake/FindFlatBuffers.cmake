...
if(FLATBUFFERS_FOUND)
  function(FLATBUFFERS_GENERATE_GRPC_CPP Name)
    set(FLATC_OUTPUTS)
    foreach(FILE ${ARGN})
      get_filename_component(FLATC_OUTPUT ${FILE} NAME_WE)

      set(FLATC_OUTPUT_H
        "${CMAKE_CURRENT_BINARY_DIR}/${FLATC_OUTPUT}.grpc.fb.h")
      list(APPEND FLATC_OUTPUTS ${FLATC_OUTPUT_H})

      set(FLATC_OUTPUT_CC
        "${CMAKE_CURRENT_BINARY_DIR}/${FLATC_OUTPUT}.grpc.fb.cc")
      list(APPEND FLATC_OUTPUTS ${FLATC_OUTPUT_CC})

      add_custom_command(OUTPUT ${FLATC_OUTPUT_H}
        COMMAND ${FLATBUFFERS_FLATC_EXECUTABLE}
        ARGS --grpc --cpp -o "${CMAKE_CURRENT_BINARY_DIR}/" ${FILE}
        DEPENDS ${FILE}

...
extern int
xrootd_nullresponsebug_retrycount; ///< sometimes, XRootd gives a NULL responses on some calls, this is a bug. When it happens we retry.
extern int
xrootd_nullresponsebug_retrysleep; ///< sometimes, XRootd gives a NULL responses on some calls, this is a bug. When it happens we sleep between attempts.
